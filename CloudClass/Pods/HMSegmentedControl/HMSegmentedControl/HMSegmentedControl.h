...
typedef enum {
    ...
    HMSegmentedControlTypeTextImageLeft,//image at left
    HMSegmentedControlTypeTextImageRight,//image at right
...
/**
 *  should notify changeBlock for every touch , default is NO, if YES ,will notify
 */
@property (nonatomic) BOOL shouldNotifyEveryTouch;

@property (nonatomic) CGFloat textImageBetweenSpace;//default is 2
