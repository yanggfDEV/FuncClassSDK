...
@implementation FCIMChatGetImage

+ (UIImage*)rotateImage:(UIImage *)image
{
    int kMaxResolution = 200; // Or whatever
    return [[self class] rotateImage:image maxWidth:kMaxResolution maxHeight:kMaxResolution];
}

+ (UIImage *)rotateScreenImage:(UIImage *)image {
    int kMaxResolution = [UIScreen mainScreen].currentMode.size.width * [UIScreen mainScreen].scale;
    return [[self class] rotateImage:image maxWidth:kMaxResolution maxHeight:kMaxResolution];
}
