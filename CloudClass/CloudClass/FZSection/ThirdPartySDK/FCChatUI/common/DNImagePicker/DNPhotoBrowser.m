...
- (UIButton *)checkButton
{
    if (nil == _checkButton) {
        ...
        [_checkButton setBackgroundImage:[UIImage imageNamed:@"common_btn_checkbox_sel"] forState:UIControlStateSelected];
        [_checkButton setBackgroundImage:[UIImage imageNamed:@"common_img_unselect"] forState:UIControlStateNormal];
