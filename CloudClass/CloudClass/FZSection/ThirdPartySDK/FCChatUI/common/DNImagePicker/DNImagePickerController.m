...
- (void)viewDidLoad {
    ...
    if (!self.maxSelectedImageCount) {
        self.maxSelectedImageCount = 7;
    }
                                     ...
                                     usingBlock:^(ALAssetsGroup *assetsGroup, BOOL *stop)
         {
             ...
             if ([assetsGroupID isEqualToString:propwetyID]) {
                 *stop = YES;
                 ...
                 DNAlbumTableViewController *albumTableViewController = [DNAlbumTableViewController shareStance];
                 DNImageFlowViewController *imageFlowController = [[DNImageFlowViewController alloc] initWithGroupURL:assetsGroupURL maxImageCount:self.maxSelectedImageCount];
