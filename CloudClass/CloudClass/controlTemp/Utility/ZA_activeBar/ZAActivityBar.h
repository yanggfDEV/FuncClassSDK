...
// Visual Properties
#define BAR_COLOR [[UIColor blackColor] colorWithAlphaComponent:0.4f]  //修改背景透明度，背景颜色。dfm
#define HEIGHT 40.0f
...
// Properties
@property (nonatomic, strong) NSMutableDictionary *activityBarStadusForAction;
@property (nonatomic) BOOL boundTouch;
